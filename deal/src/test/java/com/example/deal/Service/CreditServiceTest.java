...
import com.example.deal.service.impl.CreditServiceImpl;
...
public class CreditServiceTest {
    ...
    void testCreateCredit_Success() {
        ...
        when(creditMapper.toCreditEntity(creditDto)).thenReturn(creditEntity);
        when(creditRepository.save(creditEntity)).thenReturn(creditEntity);

        UUID resultId = creditServiceImpl.createCredit(creditDto);
        ...
        verify(creditMapper, times(1)).toCreditEntity(creditDto);
    }
}
